        ...
        <div class="col-full">
            ...
            <ul id="menu-top-bar-right" class="nav menu-top-bar-right">
                <li class="hidden-sm-down menu-item animate-dropdown">
                    <a title="Lacak paket" href="track-your-order.html">
                        <i class="tm tm-order-tracking"></i>Lacak paket</a>
                </li>
                <li class="menu-item">
                    <a title="Tentang Native" href="login-and-register.html">Tetang Native</a>
                </li>
                <li class="menu-item">
                    <a title="Kerjasama Native" href="login-and-register.html">Kerjasama Native</a>
                </li>
                <li class="menu-item">
                    <a title="Mulai berjualan" href="login-and-register.html">Mulai berjualan</a>
                </li>
            </ul>
            <!-- .nav -->
        </div>
                    ...
                    <div id="departments-menu" class="dropdown departments-menu">
                        ...
                        <ul id="menu-departments-menu" class="dropdown-menu yamm departments-menu-dropdown">
                            <li class="highlight menu-item animate-dropdown">
                                <a title="Value of the Day" href="home-v2.html">Kategori 1</a>
                            </li>
                            <li class="highlight menu-item animate-dropdown">
                                <a title="Top 100 Offers" href="home-v3.html">kategori 2</a>
                            </li>
                            <li class="highlight menu-item animate-dropdown">
                                <a title="New Arrivals" href="home-v4.html">kategori 3</a>
                            </li>
                        ...
                        <div class="input-group">
                            ...
                            <div class="input-group-addon search-categories popover-header">
                                <select name='product_cat' id='product_cat' class='postform resizeselect'>
                                    ...
                                    <option class="level-0" value="television">kategori 1</option>
                                    <option class="level-0" value="home-theater-audio">kategori 2</option>
                                </select>
                            </div>
                            <!-- .input-group-addon -->
